...
**Note:** Replace `nextgen-agents-app` with a globally unique name (3-24 characters, letters/numbers/hyphens only).
...
```bash
# Visit the web app
open "https://nextgen-agents-app.azurewebsites.net"

# Or test with curl
curl https://nextgen-agents-app.azurewebsites.net
```
