...
echo "------------------------------"
set_secret "azure-openai-endpoint" "Azure OpenAI Endpoint" "https://reapaihub6853304142.openai.azure.com/"
set_secret "azure-deployment-name" "Deployment Name" "NextGenGPT"
...
set_secret "azure-resource-group" "Resource Group Name" "NextGen_Agents"
echo ""
