...
- [ ] Key Vault (`nextgen-agents-kv`) already created
...
- [ ] Choose a globally unique name (3-24 chars, alphanumeric + hyphens)
  - Suggestion: `nextgen-agents-app` (or with your initials)

```bash
app_name="nextgen-agents-app"
...
- [ ] Check Key Vault policy: `az keyvault show-deleted --name nextgen-agents-kv`
