...
All sensitive configuration is managed in Key Vault (`your-keyvault-name`):
...
| `azure-resource-group` | Azure resource group name | your-resource-group |
...
az monitor activity-log list \
  ...
  --resource-name your-keyvault-name
...
1. Verify Key Vault exists: `az keyvault show --name your-keyvault-name`
2. Verify you're authenticated: `az account show`
3. Check VNet restrictions: `az keyvault show -n your-keyvault-name --query properties.networkAcls`
