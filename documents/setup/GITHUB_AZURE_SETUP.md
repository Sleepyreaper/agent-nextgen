...
- Azure Web App already deployed (`your-webapp.azurewebsites.net`)
- Access to Azure Portal

## Step 1: Get Azure Web App Publish Profile

1. Go to [Azure Portal](https://portal.azure.com)
2. Navigate to **App Services** → **your-webapp-name**
...
To add these:
1. Azure Portal → App Services → **your-webapp-name** → **Configuration**
...
5. Once complete, visit `https://your-webapp.azurewebsites.net/` to verify deployment
...
3. For Azure logs, visit Azure Portal:
   - **App Services** → **your-webapp-name** → **Deployment center** or **Log stream**
